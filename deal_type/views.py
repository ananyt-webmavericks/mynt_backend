...
class DealTypeApiView(APIView):
    ...
    def patch(self, request, *args, **kwargs):
        try:
            deal_type = DealType.objects.get(deal_name = request.data.get('deal_name'))
            if request.data.get('deal_name'):
                deal_type.deal_name = request.data.get('deal_name')
            
                     
            deal_type.save()
            updated_deal_type = DealType.objects.get(deal_name = request.data.get('deal_name'))
